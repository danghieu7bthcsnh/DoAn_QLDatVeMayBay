...
namespace QLDatVeMayBay.Migrations
{
    ...
    [Migration("20250721074832_FixTheThanhToanNguoiDung2")]
    partial class FixTheThanhToanNguoiDung2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QLDatVeMayBay.Models.Entities.TheThanhToan", b =>
                {
                    ...
                    b.ToTable("TheThanhToan", t =>
                        {
                            t.Property("IDNguoiDung")
                                .HasColumnName("IDNguoiDung1");
                        });
                });
